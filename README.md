...
```
The prediction result generated by our model will be saved as result.npy. contam_genes.txt will contain the genes whose probes locats at contaminated area. In order to recover the contaminated region, you should have the original CEL file in hand, and run the following command:
```
R recover_example.R
