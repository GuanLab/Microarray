...
(train_line,test_line)=GS_split.GS_split('train_2_cv.dat',size)  # to split train and train-validation set
...
callbacks = [
    ...
    keras.callbacks.ModelCheckpoint(os.path.join('./', "weights_cv2.h5"),
